import { throttled } from "./utils.mjs";

export function Slideshow(containerSelector, imgBoxSelector) {
...
export function SlideshowNavigator(selector) {
...
export function SlideshowPre(selector) {
...
export function SlideshowNext(selector) {
